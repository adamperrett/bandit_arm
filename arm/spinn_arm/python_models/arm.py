...
# Arm
# ----------------------------------------------------------------------------
class Arm(ApplicationVertex, AbstractGeneratesDataSpecification,
    ...
    def get_connections_from_machine(self, transceiver, placement, edge, graph_mapper,
        ...
        super(Arm, self).get_connections_from_machine(transceiver, placement, edge,
    ...
    def add_pre_run_connection_holder(self, connection_holder, projection_edge, synapse_information):
        super(Arm, self).add_pre_run_connection_holder(connection_holder, projection_edge, synapse_information)

    # def get_binary_start_type(self):
    #     super(Arm, self).get_binary_start_type()
    #
    ...
    def get_maximum_delay_supported_in_ms(self, machine_time_step):
        # Arm has no synapses so can simulate only one time step of delay
    ...
    def create_machine_vertex(self, vertex_slice, resources_required,
        ...
        return ArmMachineVertex(resources_required, constraints, self._label)
